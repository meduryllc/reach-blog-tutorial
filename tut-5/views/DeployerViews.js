    ...
    return (
      <div className='Card'>
        ...
        <div id='using-the-app' style={{textAlign:'left', fontSize:'20px', marginTop:'3%', marginBottom:'3%',marginLeft:'1%'}}>
          ...
          <ul>
            <li>In the <img className='Icons' src={read} alt="Read" /> Read Thoughts section, you can view all the thoughts from the streams you've subscribed to earlier.</li> <br/>
